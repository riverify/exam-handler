...
(
    classroom_number varchar(32) not null comment '考场号',
    classroom_campus varchar(32) not null comment '所在校区',
    classroom_size   int         not null comment '可用座位',
    classroom_status int default 0 null comment '考场状态（0：空闲）'
) comment '考场表';

create table school_student
(
    student_id        char(32)    not null comment '学号',
    student_name      char(32)    not null comment '姓名',
    student_major     char(32)    not null comment '专业名称',
    student_teacher   char(32)    not null comment '教师',
    student_category  char(32)    not null comment '学科类别',
    student_campus    int null comment '校区',
    student_day       int         not null comment '星期几',
    student_session   int         not null comment '第几节',
    student_classroom varchar(64) null comment '上机课地点',
    status            char default '0' null comment '状态（0正常 1停用）',
    student_className varchar(32) not null
) comment '学生信息表';
